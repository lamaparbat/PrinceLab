...
import styles from '../../../styles/AiStore/InstallPopupModel/index.module.css';
import $ from 'jquery';
        ...
        <div className={styles.input_div}>
            {
                type === "Health" ?
                    <>
                        <h5>Recorded list</h5>
                        <div className={styles.input_div_item + " mt-3"}>
                            <AudioFileOutlinedIcon className={"p-2 " + styles.icons} />
                ...
                type === "Goodnight" ?
                    <>
                        ...
                        <input
                            ...
                            id={styles["number"]}
                        />
                        <span id={styles["predict_input_title"]}>Area</span>
                        <input
                            type={"text"}
                            className={"form-control"}
                            id={styles["area"]}
                        />
                        <span id={styles["predict_input_title"]}>Location</span>
                        <input
                            type={"text"}
                            className={"form-control"}
                            id={styles["location"]}
...
const OutputComp = ({ type }) => {
    if (type === "Toxic") {
        ...
        return <>
            <div className={styles.input_div + " p-0 d-flex flex-column align-items-center"}>
                <h5 className={"bg-primary text-white p-2 px-3 position-relative"} id={styles["result_title"]}>Result</h5>
                <div className={styles.input_div_item + " d-flex flex-column p-2 mt-3 w-75"}>
                    <span><b>Name:</b> <font id={styles["name"]}></font></span>
                    <span><b>Probability:</b> <font id={styles["probab"]}></font></span>
                </div>
                <br /><br />
            </div>
        </>
        ...
        return <>
            <div className={styles.input_div + " p-0 d-flex flex-column align-items-center"}>
                <h5 className={"bg-primary text-white p-2 px-3 position-relative"} id={styles["result_title"]}>Result</h5>
                <div className={styles.input_div + " d-flex flex-column p-2 mt-3 w-75"}>
                    <span><b>Name:</b> <font id={styles["name"]}></font></span>
                    <span><b>Probability:</b> <font id={styles["probab"]}></font></span>
                </div>
                <br /><br />
...
const InstallPopupBottomNavbar = ({ type }) => {
    ...
    return (
        <div className={isWebCamOpen ? styles.installBottomNav + " mb-5 w-100 d-flex flex-column justify-content-center align-items-center" : styles.installBottomNav+" mb-5 w-100"}>
            {
                ...
                type === "img_classification" ?
                    <>
                        <div className={isWebCamOpen ? "d-none" : "rounded-pill btn mx-4 save p-2"}>
                            <input type="file" className="d-none" id={styles["hidden_img"]} onChange={saveFileData} />
...
const Index = ({ data }) => {
    return (
        <div className={"container-fluid py-5 " + styles.install_discover}>
            <div className={styles.install_discover_card}>
                <InstallPopupNavbar /><br /><br />
                {
                    data.title === "Health" ?
                        <>
                            <div className={styles.discover_card_content}>
                                <InputComp type={data.title} />
                                <img
                                    src={"/assets/connector.png"} alt="connector" />
                        ...
                        <>
                            <div className={"discover_card_content"}>
                                <div className={"photoContainer"}>
                                    <img src={"/assets/img_icon.png"} id={"photo_icon"} alt="photo_icon" />
                                </div>
                                <img
                                    src={"/assets/connector.png"} alt="connector"  />
                                <OutputComp type={data.title} />
                ...
                }
                {
                    data.title === "Goodnight" ?
                        <>
                            <div className={"discover_card_content"}>
                                <div className={"photoContainer"}>
                                    <img src={ "/assets/img_icon.png"} id={"photo_icon"} />
                                </div>
                                <img
                                    src={"/assets/connector.png"} alt="connector"/>
                                <OutputComp type={data.title} />
