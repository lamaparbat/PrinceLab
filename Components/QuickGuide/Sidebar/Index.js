...
import styles from '../../../styles/QuickGuide/Sidebar/index.module.css';
import 'animate.css';
...
const Index = () => {
    ...
    const SwitchBar = () => {
        return (
            <div className={styles.quick_guide_sidebar_switch}>
    ...
    return (
        <div
            className={
                styles.quick_guide_sidebar+" animate__animated animate__slideInLeft animate__faster pt-2 d-" +
        ...
        >
            <br /><br />
            <SwitchBar /><br /><br />
            <ul className={styles.quick_guide_sidebar_list}>
                ...
                <ul className={styles.getting_started_sublist + ' d-' + (sublistType === "list1" ? "block" : "none")} id={styles["sublist1"]}>
                    <li></li>
                </ul>
                ...
                <ul className={styles.getting_started_sublist+' d-' + (sublistType === "list2" ? "block" : "none")} id='sublist2'>
                ...
                <li style={(sublistType === "list3" ? { background: "#ececec" } : {})} id='list3' onClick={(e) => showSubList(e, "list3")}>
                    ...
                    <KeyboardArrowDownIcon
                        id={styles["arrowIcon3"]}
                    />
                </li>
                <ul className={styles.getting_started_sublist+' d-' + (sublistType === "list3" ? "block" : "none")} id='sublist3'>
                    <li>Menu Bar</li>
                ...
                <li style={(sublistType === "list4" ? { background: "#ececec" } : {})} id='list4' onClick={(e) => showSubList(e, "list4")}>
                    ...
                    <KeyboardArrowDownIcon
                        id={styles["arrowIcon4"]}
                    />
                </li>
                <ul className={styles.getting_started_sublist+' d-' + (sublistType === "list4" ? "block" : "none")} id='sublist4'>
                ...
                <li style={(sublistType === "list5" ? { background: "#ececec" } : {})} id='list5' onClick={(e) => showSubList(e, "list5")}>
                    ...
                    <KeyboardArrowDownIcon
                        id={styles["arrowIcon5"]}
                    />
                </li>
                <ul className={styles.getting_started_sublist+' d-' + (sublistType === "list5" ? "block" : "none")} id='sublist5'>
                ...
                <li style={(sublistType === "list6" ? { background: "#ececec" } : {})} id='list6' onClick={(e) => showSubList(e, "list6")}>
                    ...
                    <KeyboardArrowDownIcon
                        id={styles["arrowIcon6"]}
                    />
                </li>
                <ul className={styles.getting_started_sublist+' d-' + (sublistType === "list6" ? "block" : "none")} id='sublist6'>
